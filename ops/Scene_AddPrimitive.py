...
Usage:
    from ops.Scene_AddPrimitive import main as op_add_prim, PrimitiveKind
...
from utils.primitives_constants import (
    CMD_OPEN_MERGE_TOOL,
...
from utils.primitives_constants import (  # noqa: F401
...
def main(
    ...
    Args:
        ...
        cmd:   The magic UI string for the specific primitive
               (from utils.primitives_constants)
