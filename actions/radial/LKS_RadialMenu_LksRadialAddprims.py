"""
Show radial menu: LKS_Radial_AddPrims
...
def main() -> None:
    ...
    config_path = Path(__file__).parent.parent / "../data/library/radial_menus/LKS_Radial_AddPrims.json"
    ...
    if not loaded.items:
        print(f"[RadialMenu] No menu items in config: LKS_Radial_AddPrims.json")
        return
    ...
    manager.show_menu(
        loaded.items,
        action_id="LKS_Radial_LksRadialAddprims",
