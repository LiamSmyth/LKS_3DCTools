...
from the modular utils.hotkey_editor package.

For new code, import directly from the package:
    from utils.hotkey_editor import launch_hotkey_editor, HotkeyEditorWindow

Usage:
    # From terminal (standalone, for testing outside 3DCoat):
    python -m utils.hotkey_editor
    python -m utils.hotkey_editor "C:/path/to/Options_Hotkeys.xml"
...
from utils.hotkey_editor import (
    HAS_QT,
    EDITOR_STYLESHEET,
    count_conflicts,
...
from utils.hotkey_editor.styles import (
    COL_COMMAND,
    COL_KEY,
    COL_MODIFIERS,
    COL_ROOM,
