"""CollapsibleSection — 3DCoat-styled wrapper around lks_utils QCollapsibleSection.
...
from lks_utils.gui_qt.widgets.collapsible_section import QCollapsibleSection as _QCollapsibleSection
...
if HAS_QT:
    ...
    # Install hooks on the lks_utils class (only once)
    ...
    class CollapsibleSection(QFrame):
        ...
        def __init__(
            ...
            # Create inner lks_utils section.
            ...
            # lks_utils default is Maximum, ensuring content hugs tightly.
