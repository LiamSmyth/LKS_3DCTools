...
Most widgets are now thin re-exports from lks_utils:
...
- add_tooltip: Utility function for adding tooltips (→ lks_utils add_tooltip)
...
- SvgIcon/SvgIconButton/get_icon: SVG icon widgets (self-contained, uses lks_utils helpers)
