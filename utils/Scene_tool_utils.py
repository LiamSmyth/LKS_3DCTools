...
Usage:
    from utils.Scene_tool_utils import with_paint_tool, select_std_pen
...
# Sculpt tools (sampling - may not work for layer ops)
CMD_CLAY: str = "$Clay"
CMD_CARVE: str = "$Carve"
CMD_BUILD: str = "$Build"
...
def is_paint_tool_active() -> bool:
    """Check if a paint tool (one that works with layer ops) is active."""
