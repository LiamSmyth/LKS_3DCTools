...
Usage:
    from utils.coat_menu_utils import register_action, register_actions_from_discovery
...
if TYPE_CHECKING:
    from utils.action_discovery import ActionInfo
...
def get_lks_root() -> Path:
    ...
    """
    # This file is at LKS/utils/coat_menu_utils.py
...
def log_registration_status() -> None:
    ...
    """
    from utils.action_discovery import discover_actions, group_actions_by_context
