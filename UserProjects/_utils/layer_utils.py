...
def ensure_standard_layers() -> None:
    ...
    Cleans up any extra layers created by operations like Decimate.
    """
    # Remove any empty layers first
    coat.Scene.removeEmptyLayers()

    # Get or create the standard layers
    ...
    coat.Scene.setLayerDepthOpacity(sculpt_layer, OPACITY_FULL)
    coat.Scene.setLayerColorOpacity(sculpt_layer, OPACITY_NONE)
    coat.Scene.setLayerGlossOpacity(sculpt_layer, OPACITY_NONE)
    coat.Scene.setLayerMetalnessOpacity(sculpt_layer, OPACITY_NONE)
